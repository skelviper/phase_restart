"""054 冻结导入引导：只读复用 045/049 训练侧实现，不改旧文件字节。

只暴露本链需要的东西：contact_model / data_io / reconstruction_init / formal_controller /
shared_capture_objective / round_runner（不导入 051 的 masked_objective）。
"""
from __future__ import annotations

import sys

from round_paths_054 import ROOT, S045, S049, SOURCE_045_SRC
...
from round_paths_054 import RUN  # noqa: E402


def install() -> None:
    """把 045 formal_controller 的输出目录指向本 054 运行目录（只在本进程内）。"""
