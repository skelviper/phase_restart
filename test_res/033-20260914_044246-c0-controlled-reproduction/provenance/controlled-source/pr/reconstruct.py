...
def _solver_status(result: Any, stage: StageSpec) -> tuple[str, bool, str]:
    """Classify SciPy success while retaining iteration/function limit evidence."""
    ...
    # A genuine SciPy success remains converged even if it lands on a numeric boundary.
